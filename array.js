...
3- Favorite Movie (4)
*/
var favFood =["mansaf" , "pizza" , "burger" , "spagitti" , "Hummus"]; 
var favSport =["Footbal", "Table tennis" , "Body building"] ;
var favMoive =["Pursit of happines" , "Blank point", "Man on fire", "Jhon wick"]; 
/*
4
...
*/
function firstOfArray(arrFirst){


return arrFirst[0];

}
console.log(firstOfArray(arrFirst)); 
...
*/
function lastOfArray(arrlast){

return  arrlast[arrlast.length-1]  ; 
}

document.write(arr_last); 
/*
6
